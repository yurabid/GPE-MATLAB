...
tau = 10000 / tcoef; % decay constant
NN0=7.60e5; % number of particles
...
%             %coef = (time2-3*tz)/tz;
        ...
        cs = cos(ww*time2);
        sn = sin(ww*time2);
        VVV = coef*cmax*exp(-0.112254*((XXg-r0*cs).^2 + (YYg-r0*sn).^2));
