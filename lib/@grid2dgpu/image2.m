function [a1, a2] = image2(obj,phi,varargin)
...
cdata1 = gather(abs(slice).^2);
cdata2 = gather(angle(slice));
rx = gather(obj.x);
ry = gather(obj.y);
...
colorbar(a2,'Position',[bbox(1)+bbwidth*0.925 bbox(2)+bbheight*0.15 bbwidth*0.02 bbheight*0.72],'YTick',[-3.14 0 3.14], 'LineWidth', 1, opts{:});
