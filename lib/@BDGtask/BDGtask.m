...
%                     k = kron(speye(n2),k) + kron(obj.kinen{i},speye(n1));
        ...
        function mu=get_mu2(obj)
            mu = (eigs(obj.h0 + obj.nlin,1,'sm'));
            obj.mu = mu;
        end        
        function [vv,sp]=solve(obj,nlev)
%              opts.v0 = [obj.reshape_nto1(obj.phi); obj.reshape_nto1(obj.phi)];
             [vv,dd] = eigs(obj.mtot,nlev,'sm','StartVector',[obj.reshape_nto1(obj.phi); obj.reshape_nto1(obj.phi)]);
