function [phi, varargout] = groundstate_resc(task,eps,phi)
% Calculate the stationary state of multicomponent GPE with split-step Imaginary Time Propagation method.
